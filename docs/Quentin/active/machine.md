> **v0.1.0 shipped 2026-07-04** — full plan/log of the previous work package: `docs/Quentin/archive/v0.1.0-version-aware-retrieval/machine.md`. Next work package: TBD with Quentin.
