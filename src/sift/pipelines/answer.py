...
_SYSTEM_PROMPT = (
    ...
    '"...suits remote teams (Angel.pdf, p.1)." — never "...suits remote teams/Angel.pdf,1." '
    'and never "...suits remote teamsAngel.pdf, p.1" with no space/parentheses separating the '
